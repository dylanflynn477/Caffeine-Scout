...
def _csv_row(offer: Offer) -> dict[str, Any]:
    return {
        ...
        "regular_price": str(offer.regular_price) if offer.regular_price else None,
        "promotion_text": offer.promotion_text,
        "promotion_required_quantity": offer.promotion_required_quantity,
        "promotion_total": str(offer.promotion_total) if offer.promotion_total else None,
        "promotional_unit_price": (
            str(offer.promotional_unit_price) if offer.promotional_unit_price else None
        ),
